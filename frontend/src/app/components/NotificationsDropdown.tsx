...
import { useNotifications, type AppNotification } from "../../lib/notificationsStore";
...
export function NotificationsDropdown({
  ...
  const { notifications: items, markAllRead: markAllReadShared, markRead, unreadCount } = useNotifications();
